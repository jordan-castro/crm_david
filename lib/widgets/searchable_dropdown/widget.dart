...
import 'package:crm_david/widgets/searchable_dropdown/controller.dart' as custom_controller;
import 'package:crm_david/widgets/searchable_dropdown/custom_inkwell.dart';
import 'package:crm_david/widgets/searchable_dropdown/custom_search_bar.dart';
...
class SearchableDropdown<T> extends StatefulWidget {
  const SearchableDropdown({
    Key? key,
    custom_controller.SearchableDropdownController<T>? controller,
    Widget? hintText,
  ...
  final custom_controller.SearchableDropdownController<T>? controller;
...
class _SearchableDropdownState<T> extends State<SearchableDropdown<T>> {
  late final custom_controller.SearchableDropdownController<T> dropdownController;

  @override
  void initState() {
    dropdownController = widget.controller ?? custom_controller.SearchableDropdownController<T>();
    dropdownController
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: CustomSearchBar(
        textInputType: controller.textInputType,
...
class _DropDownListView<T> extends StatefulWidget {
  ...
  final custom_controller.SearchableDropdownController<T> dropdownController;
  final void Function(T? value)? onChanged;
  final Widget? noRecordText;
                          ...
                          itemBuilder: (context, index) {
                            if (index < itemList.length) {
                              ...
                              return ValueListenableBuilder(
                                ...
                                builder: (
                                  context,
                                  custom_controller.SearchableDropdownStatus state,
                                  child,
                                ) {
                                  if (state == custom_controller.SearchableDropdownStatus.busy) {
                                    return const Center(
                                      child:
